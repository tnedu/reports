...
dist %>%
    filter(page == "3a") %>%
    ggplot(aes(x = as.factor(GradYear ), y = pct_enroll, fill = as.factor(cohortyear))) +
        ...
        geom_bar(aes(x=as.factor(GradYear), y=pct_enroll_state),stat="identity",position=position_dodge()) +
        theme_hc() +
        theme(axis.text.y = element_text(family = "serif"),
            axis.text.x = element_text( family = "serif", face = "bold"),
            plot.title = element_text(family = "serif")) +
        scale_fill_manual(name = "Graduation Year", values = c("#e02f11", "#24336b", "#959595")) +
        annotate("text", x="2014", y=(StateRate$max_rate+20), 
                  label =paste("2015 State PS Enrollment Rate: ", StateRate$pct_enroll_state, "%"),fontface="italic") +
