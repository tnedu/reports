...
gradcohort %>%
  ...
  select(`District Name`,`Graduation Rate`, `% CTE`, `% BHN`,`% ED`, `% SWD`, `% EL`, `Avg. ACT (Highest)`, `% EPSO`) %>%  knitr::kable(col.names = c("District Name","Graduation Rate", "% CTE", "% BHN","% ED", "% SWD", "% EL", "Avg. ACT (Highest)", "% EPSO"),align="lrrrrrrrr", caption="2015 Graduates")
```
